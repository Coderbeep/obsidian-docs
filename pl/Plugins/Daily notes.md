...
- Run **Open today's daily note** from the [[pl/Plugins/Command palette]].
- [[en/Customization/Custom hotkeys#Setting hotkeys|Use a hotkey]] for the **Open today's daily note** command.
...
If your daily notes have the same structure, you can use a [[pl/Plugins/Templates|template]] to add pre-defined content to your daily notes when you create them.
