The File explorer lets you manage files and folders inside your vault. You can browse notes and other [[en/Advanced topics/Accepted file formats]] in your vault and perform many common file operations:
...
To learn about other ways to create a note, refer to [[en/How to/Create notes]].
...
For more information, refer to [[en/Advanced topics/Deleting files]].
...
When you rename a file, Obsidian automatically updates all the links to that file. For more information, refer to [[en/How to/Rename notes]].
