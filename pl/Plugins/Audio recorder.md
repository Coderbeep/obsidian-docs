...
Obsidian saves the recorded audio file to your vault and [[en/Linking notes and files/Embedding files|embeds]] it at the end of the active note.

> [!note]
> Audio recordings remain in your vault even after you remove them from your note. If you want to remove the recording from your computer, you can use the [[pl/Plugins/File explorer]] to delete the file.
