...
- In the [[pl/Plugins/File explorer]], right-click the folder you want to create the canvas in.
- Select **New canvas**.
...
> [!note]
> Text-only cards don't appear in [[pl/Plugins/Backlinks]]. To make them appear, you need to convert them to a file.
...
Or, you can add them to the canvas by dragging the file from the [[pl/Plugins/File explorer]].
