...
> [!tip]
> By default, metadata is only visible in the [[pl/Editing and formatting/Editing and previewing Markdown#Editor views|editing view]].
>
...
| Key | Description |
|-|-|
| `tag` | See [[pl/Editing and formatting/Tags\|Tags]]. |
| `tags` | Alias for `tag`. |
