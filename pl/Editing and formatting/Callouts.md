...
> [!info]
> Here's a callout block.
> It supports **Markdown**, [[en/Linking notes and files/Internal links|Wikilinks]] and [[en/Linking notes and files/Embedding files|embeds]]!
> ![[en/og-image.png]]
...
[[en/Extending Obsidian/CSS snippets]] and [[en/Extending Obsidian/Community plugins]] can define custom callouts, or even overwrite the default configuration.
