...
The easiest way to sync your notes between your devices is to use [[en/Obsidian Sync/Introduction to Obsidian Sync|Obsidian Sync]]. If you already have an Obsidian Sync subscription, see how to [[en/Obsidian Sync/Set up Obsidian Sync]].

Note that using multiple syncing services at the same time (e.g., Obsidian Sync _and_ Dropbox) may cause data loss, corruption, and other issues. [[en/Obsidian Sync/Obsidian Sync and third-party services||Find out more about using Obsidian Sync with other services here.]]
