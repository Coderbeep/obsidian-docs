...
The first time you open Obsidian, you'll be asked to add a new vault from the [[en/User interface/Vault switcher]].
...
If you want to know more about how vaults work, learn how [[en/Advanced topics/How Obsidian stores data]].

Now that you've set up your vault, you're ready to [[pl/Getting started/Create your first note]].
