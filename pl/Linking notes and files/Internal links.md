...
For example, `[[Internal links|custom display text]]` appears as [[pl/Linking notes and files/Internal links|custom display text]].

**Markdown format:**

Enter the display text between the square brackets (`[]`).

For example, `[custom display text](Internal%20links.md)` appears as [custom display text](pl/Linking%20notes%20and%20files/Internal%20links.md).
