...
To add an alias for a note, add an `alias`, or `aliases`, property in the note [[en/Editing and formatting/Metadata|front matter]]:
...
1. Start typing the alias in an [[pl/Linking notes and files/Internal links|internal link]]. Any alias shows up in the list of suggestions, with a curved arrow icon next to it.
...
By using [[vi/Plugin/Backlinks]], you can find unlinked mentions of aliases.

For example, after setting "AI" as an alias for "Artificial intelligence", you can see mentions of "AI" in other notes.

If you link an unlinked mention to an alias, Obsidian turns the mention into an [[pl/Linking notes and files/Internal links|internal link]] with the alias as its display text.
