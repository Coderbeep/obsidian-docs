...
The fastest way to see the hotkey set for a command is to find the command in [[vi/Plugin/Command palette]]. If there's a hotkey listed for that command, it's set.
