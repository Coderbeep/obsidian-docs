...
To automatically select a note to be published, set `publish: true` in the [[en/Editing and formatting/Metadata]] for the note.

## Ignore notes

To ignore a note in Obsidian Publish, set `publish: false` in the [[en/Editing and formatting/Metadata]] for the note.
