Any files or settings that have been synced to your [[pl/Obsidian Sync/Local and remote vaults|remote vault]] count towards your [[pl/Obsidian Sync/Limitations#How large can each remote vault be|storage space]]. By default, [[pl/Obsidian Sync/Introduction to Obsidian Sync|Obsidian Sync]] ignores larger files such as audio, video, and PDFs.
